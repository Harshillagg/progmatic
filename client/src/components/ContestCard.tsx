    ...
    <div className="bg-red-700 h-64 w-96 rounded-3xl ml-4 ">
      <div className="bg-gray-300 h-52 w-96 pt-6 rounded-3xl">
        <div className="flex justify-between pr-4 items-center">
          <div className="text-center rounded-r-full bg-green h-8 w-28 flex justify-center items-center gap-2">
            <div>
        ...
        <div className="text-dark pl-8 pt-4">
          ...
          <div>
            <div className="relative h-8 -ml-1">
              <img className="w-8 h-8 rounded-full border-2 border-gray-400 absolute z-40 ml" src="/avatar.jpg" alt="Avatar 1" />
              <img className="w-8 h-8 rounded-full border-2 border-gray-400 absolute top-0 left-0 ml-6 z-30" src="/avatar.jpg" alt="Avatar 2" />
              <img className="w-8 h-8 rounded-full border-2 border-gray-400 absolute top-0 left-0 ml-12 z-20" src="/avatar.jpg" alt="Avatar 3" />
              <img className="w-8 h-8 rounded-full border-2 border-gray-400 absolute top-0 left-0 ml-[72px] z-10" src="/avatar.jpg" alt="Avatar 4" />
            </div>
            <span>+53 participants</span>
          </div>
        </div>
      </div>
      <p className="text-center pt-2 font-bold"><button >Register & view details</button></p>
    </div>
  );
}
